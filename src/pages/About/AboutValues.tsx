    ...
    return (
        <div className="mb-24 lg:mb-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 max-w-7xl mx-auto">
                ...
                >
                    <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-start">
                        <div className="flex-shrink-0">
                            <div className="w-16 h-16 bg-gradient-to-br from-primary to-orange-600 rounded-2xl flex items-center justify-center shadow-lg shadow-primary/20">
                                <span className="material-symbols-rounded text-white text-3xl">rocket_launch</span>
                            </div>
                        </div>
                ...
                >
                    <div className="aspect-[4/3] bg-gradient-to-br from-primary/10 to-orange-500/10 relative overflow-hidden">
                        <img
                        ...
                        <div className="absolute bottom-4 left-4 right-4">
                            <div className="w-12 h-12 bg-white/90 dark:bg-slate-900/90 rounded-xl flex items-center justify-center mb-3">
                ...
                <motion.div
                    ...
                    className="lg:col-span-2 bg-gradient-to-br from-primary to-orange-600 rounded-[2rem] p-8 md:p-10 border border-primary/20 shadow-xl shadow-primary/20 group hover:shadow-2xl hover:shadow-primary/30 transition-all duration-500 relative overflow-hidden"
                >
                    {/* Background Pattern */}
